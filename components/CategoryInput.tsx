...
const CategoryInput = forwardRef<HTMLInputElement, CategoryInputProps>(({ category, setCategory, handleSubmit, isLoading }, ref) => {
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto">
      <div className="flex flex-col sm:flex-row items-center gap-3 bg-white p-3 rounded-full shadow-lg border border-purple-200">
        <label htmlFor="story-category" className="sr-only">
          Story Category
        </label>
        <input
          id="story-category"
